...
impl<'a> ser::Serializer for &'a mut Serializer {
    ...
    fn serialize_char(self, v: char) -> Result<()> {
        self.serialize_str(&v.to_string()) // TODO: Should we treat this different? I doubt.
    }
    ...
    fn serialize_str(self, v: &str) -> Result<()> {
        write_varint_in_place(&mut self.output, v.len() as i32); // TODO: Throw if string is longer than i32 limit
    ...
    fn serialize_none(self) -> Result<()> {
        unimplemented!() // TODO: I'm not sure how to implement this yet.
    }
    ...
    fn serialize_seq(self, _len: Option<usize>) -> Result<Self::SerializeSeq> {
        //self.output += "[";
        Ok(self) // Apparently arrays are not length-prefixed? Idk!
    }
